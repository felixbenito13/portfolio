    ...
    <nav className={'nav' + (open ? ' nav-open' : '')}>
      <div className="shell nav-inner">
        ...
        <div className="nav-links">
          <a href="#work" className={active === 'work' ? 'active' : ''} onClick={close}>Work</a>
          <a href="#practice" className={active === 'practice' ? 'active' : ''} onClick={close}>Leadership &amp; AI</a>
  ...
  return (
    <section id="practice" className="section">
      <div className="shell">
        <SectionHead
          num="02"
          eyebrow="Leadership &amp; AI"
          title="How I lead, with AI inside the loop."
          lede="A design lead's real job rarely shows up in a Figma file."
        />
        <div className="split">
          ...
          <div className="callout reveal" style={{ '--rd': '160ms' }}>
            <h3>The AI proposes, the team decides, I keep the rails.</h3>
            <p>I treat AI as a junior teammate: fast at first drafts, useless without research and judgment. On Kraft Heinz, that contract cut time-to-insight from twenty hours a month to two seconds. The interesting work is the contract between a model's suggestion and a person's decision, that contract is the design.</p>
          </div>
        </div>
      </div>
    </section>
    ...
    <section id="formation" className="section formation">
      <div className="shell">
        <div className="formation-inner reveal">
          ...
          <h2 className="formation-title">Four disciplines, one straight line.</h2>
          <p className="formation-body">
            It started with a <em>degree in advertising and propaganda</em>, where audience, narrative and brand are the entire craft. A <em>postgraduate degree in design</em> turned that craft into systems and products. An <em>MBA in strategic communication</em> added the business lens, positioning, framing, the discipline of saying no. Most recently, the <em>NN/g UX Leader programme</em> set those instincts against a formal model of how design organisations actually grow. Four disciplines, one straight line, how to make complicated things matter to the right person.
          </p>
        </div>
      </div>
    </section>
    ...
    <section id="me" className="section me-section">
      <div className="shell">
        <SectionHead
          num="06"
          eyebrow="Me"
          title="Where the creativity comes from."
        ...
        <div className="me-gallery reveal">
          <figure className="me-card me-card-tall">
            <div className="me-image"><img src="assets/felix-benito-hiking-trails-nature.jpg" alt="Felix Benito hiking a trail in nature while travelling, the off-screen thinking time that informs design decisions" width="800" height="1000" loading="lazy" /></div>
            <figcaption>
              <span className="me-tag">On the road</span>
              <p>Exploring countries by road and on foot, hiking trails and staying as close to nature as I can, looking for the light, the colour, the angle.</p>
            </figcaption>
          </figure>
          <figure className="me-card me-card-tall">
    ...
    <section id="contact" className="section footer">
      <div className="shell">
        <div className="footer-inner">
          <div className="reveal">
            <span className="eyebrow no-dot" style={{ marginBottom: 18, display: 'inline-block' }}>07, Contact</span>
            <h2>
              Hiring a design lead<em>?</em><br/>
